...
final class _FetchGroupFeedProvider
    extends
        $FunctionalProvider<
  ...
  const _FetchGroupFeedProvider._({
    ...
    FutureOr<List<ChapterFeedItemData>> Function(Ref ref, Group group)? create,
  }) : _createCb = create,
       super(
         retry: noRetry,
  ...
  final FutureOr<List<ChapterFeedItemData>> Function(Ref ref, Group group)?
  _createCb;
  ...
  _FetchGroupFeedProvider $copyWithCreate(
    ...
    return _FetchGroupFeedProvider._(
      ...
      create: (ref, Group group) => create(ref),
    );
  }
...
final class _FetchGroupFeedFamily extends Family {
  ...
  _FetchGroupFeedProvider call(Group group) =>
  ...
  Override overrideWith(
    FutureOr<List<ChapterFeedItemData>> Function(Ref ref, Group args) create,
  ) {
    return $FamilyOverride(
      from: this,
      createElement: (pointer) {
...
final class _FetchGroupTitlesProvider
  ...
  const _FetchGroupTitlesProvider._({
    ...
    required Group super.argument,
    FutureOr<List<Manga>> Function(Ref ref, Group group)? create,
  }) : _createCb = create,
       super(
         retry: noRetry,
  ...
  final FutureOr<List<Manga>> Function(Ref ref, Group group)? _createCb;
...
final class _FetchGroupTitlesFamily extends Family {
  ...
  _FetchGroupTitlesProvider call(Group group) =>
  ...
  /// {@macro riverpod.override_with}
  Override overrideWith(
    FutureOr<List<Manga>> Function(Ref ref, Group args) create,
  ) {
    return $FamilyOverride(
      from: this,
      createElement: (pointer) {

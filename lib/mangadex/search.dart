      ...
      body: MangaListWidget(
        ...
        leading: [
          SliverAppBar(
            leading: BackButton(
              onPressed: () {
                context.pop(widget.selectMode ? selected.state : null);
              },
            ),
            pinned: true,
            snap: false,
                  ...
                  trailing: <Widget>[
                    Tooltip(
                      ...
                      child: IconButton(
                        ...
                        color: _searchParameters.filter.isEmpty
                            ? theme.disabledColor
                            : null,
            ...
            builder: (context) {
              ...
              final panelItems = [
                ExpansionPanel(
                  ...
                  headerBuilder: (context, isExpanded) => HookBuilder(
                    builder: (context) {
                                    ...
                                    builder: (context) {
                                      final value = useListenableSelector(
                                        ...
                                        () => fil.value.includedTags.contains(e)
                                            ? true
                                            : (fil.value.excludedTags.contains(
                                                    e,
                                                  )
                                                  ? false
                                                  : null),
    ...
    return SearchAnchor.bar(
      suggestionsBuilder:
          (BuildContext context, SearchController controller) async {
            final List<CreatorType>? options = (await _debouncedSearch(
              controller.text,
            ))?.toList();
            if (options == null) {
              return _lastOptions;
